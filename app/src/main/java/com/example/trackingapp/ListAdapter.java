...
public class ListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View child, ViewGroup parent) {
        ...
        if (child == null) {
            ...
            holder.Latitude = child.findViewById(R.id.textLatitude);
            holder.Longitude = child.findViewById(R.id.textLongitude);
            holder.Date_Time = child.findViewById(R.id.textDateTime);
